  ...
  return (
    <React.Fragment>
      <MDBContainer>
        ...
        <p className='px-5' style={{ textAlign: 'center' }}><b>Disclaimer: </b>This kiosk is designed to aid in the decision making of the patient and lead them proper channels for further consultation and analysis. The results are <b>NOT FINAL</b> <b>NOR A DEFINITIVE DIAGNOSIS</b>, but a indicator which can be used by a doctor to narrow down the patient's possible disease/s based on symptoms.</p>
