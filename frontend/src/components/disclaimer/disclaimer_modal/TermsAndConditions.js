              ...
              <MDBRow className='px-2'>
                {
                  language === "PH" ?
                    <div>
                      ...
                      <p>Ang sistema ay self-service na health kiosk na sumusukat sa mga vital signs, nagsasagawa ng differential diagnosis, pati na rin ang paghahanap sa mga kalapit na pasilidad ng kalusugan. Dahil sa limitadong availability ng mga dataset, ang pagpili ng sakit/sintomas ay limitado sa general medicine upang paliitin ang pagtuon tungkol sa availability ng mga dataset. Susubukang alamin ng self-service health kiosk ang mga posibleng sakit na maaaring magkaroon ng pasyente depende sa mga sintomas na nakolekta mula sa pasyente. Dagdag pa, ang sistema ay magpapakita ng impormasyon tungkol sa mga sakit at ang mga pag-iingat sa doktor na maaari niyang ibigay sa pasyente base sa kanyang paghuhusga sa mga resulta. Ipapakita ang pinakamalapit na ospital batay sa pisikal na lokasyon kung saan naka-deploy ang kiosk. Ang paghahanap sa mga pinakamalapit na ospital ay gagawin sa pamamagitan ng mga tawag sa API mula sa third-party na API, kaya ang pangangailangan para sa device na palaging konektado sa internet. Ang mga serbisyo ng API na ito ay ang Maps API at Places API na ibinigay ng Google Maps. Samakatuwid, ang katumpakan ng mga kalapit na rekomendasyon sa ospital ay nakasalalay sa katumpakan ng natukoy na lokasyon ng GPS ng kiosk kasabay ng mga serbisyo ng API na ibinibigay ng Google.</p>
                      <h5>Seguridad at Pagkakumpidensyal</h5>
                      <p>Ang lahat ng nakolektang impormasyon mula sa mga pasyente ay naka-imbak sa database ng kiosk at gagamitin lamang para sa pagkakakilanlan ng pasyente. Hindi ito ibababhagi sa ibang mga organisasyon, at ang mga contact number na nakolekta ay gagamitin lamang para sa pagpapadala ng mga resulta at notification para sa mga posibleng appointment.</p>
